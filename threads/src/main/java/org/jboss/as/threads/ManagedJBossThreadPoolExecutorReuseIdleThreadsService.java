 ...
 * @author panos
 */
public class ManagedJBossThreadPoolExecutorReuseIdleThreadsService extends ManagedExecutorService implements BlockingExecutor {

    private final JBossThreadPoolExecutorReuseIdleThreads executor;

    public ManagedJBossThreadPoolExecutorReuseIdleThreadsService(JBossThreadPoolExecutorReuseIdleThreads executor) {
        super(executor);
