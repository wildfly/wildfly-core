...
class ModifiableKeyStoreDecorator extends DelegatingResourceDefinition {
    ...
    ModifiableKeyStoreDecorator(final Class<?> extensionClass, ResourceDefinition resourceDefinition) {
    ...
    static class ReadAliasesHandler extends ElytronRuntimeOnlyHandler {
        ...
        static final SimpleAttributeDefinition RECURSIVE = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.RECURSIVE, ModelType.BOOLEAN, true)
                .setAllowExpression(false)
                .setDefaultValue(ModelNode.FALSE)
                .build();

        static final SimpleAttributeDefinition VERBOSE = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.VERBOSE, ModelType.BOOLEAN, true)
                .setAllowExpression(false)
