...
final class KeyStoreDefinition extends SimpleResourceDefinition {
    ...
    static final ServiceUtil<KeyStore> KEY_STORE_UTIL = ServiceUtil.newInstance(KEY_STORE_RUNTIME_CAPABILITY, ElytronCommonConstants.KEY_STORE, KeyStore.class);
    ...
    static KeyStoreDefinition configure(final Class<?> extensionClass) {
        ...
        protected void performRuntime(ModelNode result, OperationContext context, ModelNode operation, final KeyStoreService keyStoreService) throws OperationFailedException {
            ...
            switch (operationName) {
                ...
                case ElytronCommonConstants.STORE:
                    ...
                    break;
                default:
                    throw ROOT_LOGGER.invalidOperationName(operationName, ElytronCommonConstants.LOAD,
