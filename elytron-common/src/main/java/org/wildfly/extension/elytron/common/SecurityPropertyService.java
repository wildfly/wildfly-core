...
public class SecurityPropertyService implements Service<Void> {
    ...
    public SecurityPropertyService(Map<String, String> propertiesToBeSet) {
        toSet.putAll(propertiesToBeSet);
    }

    public static ServiceName serviceName(String subsystemName) {
        return serviceName(ServiceName.of(subsystemName));
    }

    public static ServiceName serviceName(ServiceName subsystemName) {
        return subsystemName.append(ElytronCommonConstants.SECURITY_PROPERTIES);
    }
