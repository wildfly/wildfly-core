...
import static org.wildfly.extension.elytron.ElytronCommonCapabilities.CERTIFICATE_AUTHORITY_CAPABILITY;
...
class CertificateAuthorityAccountDefinition extends SimpleResourceDefinition {
    ...
    static final StringListAttributeDefinition CONTACT_URLS = new StringListAttributeDefinition.Builder(ElytronCommonConstants.CONTACT_URLS)
            .setRequired(false)
    ...
    static final SimpleAttributeDefinition CERTIFICATE_AUTHORITY = new CertificateAuthorityDefinitionBuilder(ElytronCommonConstants.CERTIFICATE_AUTHORITY, ModelType.STRING, true)
    ...
    static final SimpleAttributeDefinition KEY_STORE = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.KEY_STORE, ModelType.STRING, false)
    ...
    static final SimpleAttributeDefinition AGREE_TO_TERMS_OF_SERVICE = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.AGREE_TO_TERMS_OF_SERVICE, ModelType.BOOLEAN, false)
            .setAllowExpression(true)
            .build();
    ...
    private static class CertificateAuthorityAccountAddHandler extends ElytronCommonBaseAddHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
            ...
            if (certificateAuthorityName.equalsIgnoreCase(CertificateAuthority.LETS_ENCRYPT.getName())) {
                commonRequirements(extensionClass, acmeAccountServiceBuilder).install();
            } else {
    ...
    static CertificateAuthorityAccountDefinition configure(final Class<?> extensionClass) {
        ...
        TrivialCapabilityServiceRemoveHandler caAcctRemoveHandler = new TrivialCapabilityServiceRemoveHandler(caAcctAddHandler, CERTIFICATE_AUTHORITY_ACCOUNT_RUNTIME_CAPABILITY);

        return new CertificateAuthorityAccountDefinition(caAcctResourceResolver, caAcctAddHandler, caAcctRemoveHandler);
    }

    private CertificateAuthorityAccountDefinition(StandardResourceDescriptionResolver caAcctResourceResolver, CertificateAuthorityAccountAddHandler caAcctAddHandler,
    ...
    static class CreateAccountHandler extends ElytronRuntimeOnlyHandler {
        ...
        protected void executeRuntimeStep(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            try {
                ...
                if (! created) {
                    throw ROOT_LOGGER.certificateAuthorityAccountAlreadyExists(ElytronCommonConstants.UPDATE_ACCOUNT, ElytronCommonConstants.CHANGE_ACCOUNT_KEY);
                }
    ...
    static class UpdateAccountHandler extends ElytronRuntimeOnlyHandler {
        static final SimpleAttributeDefinition UPDATE_AGREE_TO_TERMS_OF_SERVICE = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.AGREE_TO_TERMS_OF_SERVICE, ModelType.BOOLEAN, true)
                .setAllowExpression(true)
                .build();
