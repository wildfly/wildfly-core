 ...
 */
public class SSLContextResource extends DelegatingResource {

    private ServiceController<SSLContext> sslContextServiceController;
    private boolean server;

    public SSLContextResource(Resource delegate, boolean server) {
        super(delegate);
        this.server = server;
    }
     ...
     */
    public static SSLContext getSSLContext(ServiceController<SSLContext> sslContextServiceController) {
