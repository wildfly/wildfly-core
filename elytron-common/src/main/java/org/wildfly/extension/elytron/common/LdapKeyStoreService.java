 ...
 */
public class LdapKeyStoreService implements ModifiableKeyStoreService {
    ...
    public LdapKeyStoreService(String searchPath, String filterAlias, String filterCertificate,
