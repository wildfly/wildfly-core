 ...
 */
public class SecurityPropertiesWriteHandler extends AbstractWriteAttributeHandler {
    private final PropertiesAttributeDefinition securityProperties;
    private final String subsystemName;

    public SecurityPropertiesWriteHandler(final String subsystemName, PropertiesAttributeDefinition attributeDefinition) {
     ...
     * @param updated
     */
    public static void doDifference(
