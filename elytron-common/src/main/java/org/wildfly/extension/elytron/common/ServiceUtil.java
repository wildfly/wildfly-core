...
public final class ServiceUtil<T> {
     ...
     */
    public ServiceName serviceName(final String name) {
     ...
     * @return The fully qualified {@link ServiceName} of the service.
     */
    public ServiceName serviceName(final ModelNode operation) {
        String name = null;
        ...
        if (name == null) {
            throw ElytronCommonMessages.ROOT_LOGGER.operationAddressMissingKey(key);
        }
     ...
     */
    public ServiceBuilder<?> addInjection(ServiceBuilder<?> sb, Injector<T> injector, String name) {
        return addInjection(sb, injector, serviceName(name));
    }

    public ServiceBuilder<?> addInjection(ServiceBuilder<?> sb, Injector<T> injector, ServiceName serviceName) {
