...
public class ElytronCommonDefinitions extends SimpleResourceDefinition {
    ...
    static <T> ServiceBuilder<T> commonRequirements(Class<?> extensionClass, ServiceBuilder<T> serviceBuilder) {
        return commonRequirements(ServiceName.of(getSubsystemName(extensionClass)), serviceBuilder);
    }

    static <T> ServiceBuilder<T> commonRequirements(ServiceName subsystemName, ServiceBuilder<T> serviceBuilder) {
        return commonRequirements(subsystemName, serviceBuilder, true, true);
    }

    static <T> ServiceBuilder<T> commonRequirements(Class<?> extensionClass, ServiceBuilder<T> serviceBuilder, boolean dependOnProperties, boolean dependOnProviderRegistration) {
    ...
    static <T> ServiceBuilder<T> commonRequirements(ServiceName subsystemName, ServiceBuilder<T> serviceBuilder, boolean dependOnProperties, boolean dependOnProviderRegistration) {
    ...
    static StandardResourceDescriptionResolver getResourceDescriptionResolver(Class<?> extensionClass,
