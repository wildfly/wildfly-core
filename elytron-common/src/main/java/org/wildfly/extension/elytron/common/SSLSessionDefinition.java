...
import static org.wildfly.extension.elytron.common.CertificateChainAttributeDefinitions.getNamedCertificateList;
...
public class SSLSessionDefinition extends SimpleResourceDefinition {
    ...
    public static SSLSessionDefinition configure(final Class<?> extensionClass, boolean server) {
    ...
    protected class SSLSessionRuntimeHandler extends SSLDefinitions.SSLContextRuntimeHandler {

        private final BiConsumer<ModelNode, SSLSession> biConsumer;

        protected SSLSessionRuntimeHandler(BiConsumer<ModelNode, SSLSession> biConsumer) {
    ...
    private static byte[] sessionId(ModelNode operation) {
        ...
        throw ElytronCommonMessages.ROOT_LOGGER.operationAddressMissingKey(ElytronCommonConstants.SSL_SESSION);
    }
}
