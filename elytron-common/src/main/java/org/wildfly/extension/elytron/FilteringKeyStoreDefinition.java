...
class FilteringKeyStoreDefinition extends SimpleResourceDefinition {
    ...
    static final ServiceUtil<KeyStore> FILTERING_KEY_STORE_UTIL = ServiceUtil.newInstance(KEY_STORE_RUNTIME_CAPABILITY, ElytronCommonConstants.FILTERING_KEY_STORE, KeyStore.class);
    ...
    static final SimpleAttributeDefinition ALIAS_FILTER = new SimpleAttributeDefinitionBuilder(ElytronCommonConstants.ALIAS_FILTER, ModelType.STRING, false)
    ...
    static FilteringKeyStoreDefinition configure(final Class<?> extensionClass) {
    ...
    private FilteringKeyStoreDefinition(StandardResourceDescriptionResolver filterKSResourceResolver, KeyStoreAddHandler filterKSAddHandler,
