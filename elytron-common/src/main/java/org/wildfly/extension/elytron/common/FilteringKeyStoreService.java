...
public class FilteringKeyStoreService implements ModifiableKeyStoreService {
    ...
    private KeyStore filteringKeyStore;
    private KeyStore modifiableFilteringKeyStore;

    public FilteringKeyStoreService(InjectedValue<KeyStore> keyStoreInjector, String aliasFilter) {
