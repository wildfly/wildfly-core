...
public abstract class ElytronCommonKeyStoresTestCase extends AbstractSubsystemTest {
    ...
    protected static CredentialStoreUtility csUtil = null;
    protected static final String CS_PASSWORD = "super_secret";
    protected static final String KEY_PASSWORD = "secret";
    ...
    protected static final String KEYSTORE_PASSWORD = "Elytron";
    protected static final X500Principal ROOT_DN = new X500Principal("O=Root Certificate Authority, EMAILADDRESS=elytron@wildfly.org, C=UK, ST=Elytron, CN=Elytron CA");
    protected static final X500Principal ANOTHER_ROOT_DN = new X500Principal("O=Another Root Certificate Authority, EMAILADDRESS=anotherca@wildfly.org, C=UK, ST=Elytron, CN=Another Elytron CA");
    ...
    protected static Supplier<File> FIREFLY_FILE = () -> new File(workingDirectoryLocation, "firefly.keystore");
    protected static Supplier<File> FIREFLY_COPY_FILE = () -> new File(workingDirectoryLocation, "firefly-copy.keystore");
    protected static Supplier<File> TEST_FILE = () -> new File(workingDirectoryLocation, "test.keystore");
    protected static Supplier<File> TEST_SINGLE_CERT_REPLY_FILE = () -> new File(workingDirectoryLocation, "test-single-cert-reply.cert");
    protected static Supplier<File> TEST_CERT_CHAIN_REPLY_FILE = () -> new File(workingDirectoryLocation, "test-cert-chain-reply.cert");
    protected static Supplier<File> TEST_EXPORTED_FILE = () -> new File(workingDirectoryLocation, "test-exported.cert");
    protected static Supplier<File> TEST_TRUSTED_FILE = () -> new File(workingDirectoryLocation, "test-trusted.cert");
    protected static Supplier<File> TEST_UNTRUSTED_FILE = () -> new File(workingDirectoryLocation, "test-untrusted.cert");
    protected static Supplier<File> TEST_UNTRUSTED_CERT_CHAIN_REPLY_FILE = () -> new File(workingDirectoryLocation, "test-untrusted-cert-chain-reply.cert");

    public ElytronCommonKeyStoresTestCase(final String mainSubsystemName, final Extension mainExtension, String workingDirectoryLocation) {
        super(mainSubsystemName, mainExtension);
        setWorkingDirectoryLocation(workingDirectoryLocation);
    }
    ...
    protected static void setWorkingDirectoryLocation(String newWorkingDirectoryLocation) {
        workingDirectoryLocation = newWorkingDirectoryLocation;
    }

    protected static void setOldHomeDir(String updatedHomeDir) {
        oldHomeDir = updatedHomeDir;
    }

    protected static String getOldHomeDir() {
        return oldHomeDir;
    }
    ...
    protected static void createTemporaryCertFile(X509Certificate certificate, File outputFile) throws Exception {
        try (FileOutputStream fos = new FileOutputStream(outputFile, true)){
            fos.write(certificate.getEncoded());
        }
    }

    protected static KeyStore createFireflyKeyStore() throws Exception {
    ...
    protected static SelfSignedX509CertificateAndSigningKey createCertRoot(X500Principal DN) {
    ...
    protected static SelfSignedX509CertificateAndSigningKey createSallyCertificate() {
        return SelfSignedX509CertificateAndSigningKey.builder()
                .setDn(SALLY_DN)
                .setKeyAlgorithmName("RSA")
                .setSignatureAlgorithmName("SHA256withRSA")
    ...
    protected static X509Certificate createSSmithCertificate(SelfSignedX509CertificateAndSigningKey rootSelfSignedX509CertificateAndSigningKey, PublicKey publicKey) throws Exception {
    ...
    protected static KeyStore createTestKeyStore(SelfSignedX509CertificateAndSigningKey rootSelfSignedX509CertificateAndSigningKey, SelfSignedX509CertificateAndSigningKey sallySelfSignedX509CertificateAndSigningKey) throws Exception {
    ...
    protected static X509Certificate createTestTrustedCertificate(SelfSignedX509CertificateAndSigningKey rootSelfSignedX509CertificateAndSigningKey) throws Exception {
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA");
    ...
    protected static X509Certificate createTestUntrustedCertChainReplyCertificate(SelfSignedX509CertificateAndSigningKey selfSignedX509CertificateAndSigningKey, PublicKey publicKey) throws Exception {
        return new X509CertificateBuilder()
    ...
    protected static void removeTestFiles() {
        File[] testFiles = {
                FIREFLY_FILE.get(),
                FIREFLY_COPY_FILE.get(),
                TEST_FILE.get(),
                TEST_SINGLE_CERT_REPLY_FILE.get(),
                TEST_CERT_CHAIN_REPLY_FILE.get(),
                TEST_EXPORTED_FILE.get(),
                TEST_TRUSTED_FILE.get(),
                TEST_UNTRUSTED_FILE.get(),
                TEST_UNTRUSTED_CERT_CHAIN_REPLY_FILE.get()
        };
    ...
    public void testKeystoreService() throws Exception {
        ...
        KeyStore keyStore = (KeyStore) getServices().getContainer().getService(serviceName).getValue();
    ...
    protected void checkCertificate(final ModelNode certificate, final boolean verbose) {
    ...
    protected void addCertificate(KeyStore keyStore, String alias, ZonedDateTime notValidBefore, ZonedDateTime notValidAfter) throws Exception {
    ...
    protected ModelNode getExtension(boolean critical, String name, String value) {
    ...
    protected ClientAndServer setupTestObtainCertificateWithKeySize() {
    ...
    protected ClientAndServer setupTestObtainCertificateWithECPublicKey() {
        // set up a mock Let's Encrypt server
    ...
    protected ClientAndServer setupTestObtainCertificateWithUnsupportedPublicKey() {
    ...
    protected ClientAndServer setupTestRevokeCertificateWithoutReason() {
    ...
    protected ClientAndServer setupTestRevokeCertificateWithReason() {
