 ...
 */
public class ElytronCommonLdapService implements Closeable {

    private final DirectoryService directoryService;
    private final Collection<LdapServer> servers;

    protected ElytronCommonLdapService(final DirectoryService directoryService, final Collection<LdapServer> servers) {
    ...
    public static Builder getCommonBuilder() {
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public ElytronCommonLdapService start() throws Exception {
            assertNotStarted();
            started = true;
            ...
            return new ElytronCommonLdapService(directoryService, servers);
        }
