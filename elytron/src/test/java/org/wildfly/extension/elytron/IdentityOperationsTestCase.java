...
public class IdentityOperationsTestCase extends AbstractSubsystemTest {
    ...
    private ModelNode createAddAttributeOperation(PathAddress parentAddress, String principalName, String key, String... values) {
        ...
        return SubsystemOperations.OperationBuilder.create(ElytronDescriptionConstants.ADD_IDENTITY_ATTRIBUTE, parentAddress.toModelNode())
                .addAttribute(ModifiableRealmDecorator.AttributeAddHandler.IDENTITY, principalName)
                .addAttribute(ModifiableRealmDecorator.AttributeAddHandler.NAME, key)
                .addAttribute(ModifiableRealmDecorator.AttributeAddHandler.VALUE, valuesNode)
                .build();
    }
    ...
    private ModelNode createRemoveAttributeOperation(PathAddress parentAddress, String principalName, String key, String... values) {
        ...
        return SubsystemOperations.OperationBuilder.create(ElytronDescriptionConstants.REMOVE_IDENTITY_ATTRIBUTE, parentAddress.toModelNode())
                .addAttribute(ModifiableRealmDecorator.AttributeRemoveHandler.IDENTITY, principalName)
                .addAttribute(ModifiableRealmDecorator.AttributeRemoveHandler.NAME, key)
                .addAttribute(ModifiableRealmDecorator.AttributeRemoveHandler.VALUE, valuesNode)
                .build();
    }
    ...
    private ModelNode createAuthenticateOperation(PathAddress parentAddress, String principalName, String password) {
        return SubsystemOperations.OperationBuilder.create(DomainDefinition.AuthenticatorOperationHandler.getOperationName(), parentAddress.toModelNode())
                .addAttribute(DomainDefinition.AuthenticatorOperationHandler.USER_NAME, principalName)
                .addAttribute(DomainDefinition.AuthenticatorOperationHandler.PASSWORD, password)
                .build();
    }
