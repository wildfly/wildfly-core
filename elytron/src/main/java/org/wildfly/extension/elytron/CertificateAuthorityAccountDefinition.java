...
class CertificateAuthorityAccountDefinition extends SimpleResourceDefinition {
    ...
    static final ObjectTypeAttributeDefinition EXTERNAL_ACCOUNT_BINDING = new ObjectTypeAttributeDefinition.Builder(
            ...
            .setRestartAllServices()
            .setStability(Stability.PREVIEW)
            .setValidator(new ExternalAccountBindingValidator())
            .build();
    ...
    private static class ExternalAccountBindingValidator extends ObjectTypeValidator {

        private ExternalAccountBindingValidator() {
            super(true, EXTERNAL_ACCOUNT_BINDING_KEY_IDENTIFIER, EXTERNAL_ACCOUNT_BINDING_CREDENTIAL_REFERENCE);
        }

        @Override
        public void validateParameter(String parameterName, ModelNode externalAccountBinding) throws OperationFailedException {
            super.validateParameter(parameterName, externalAccountBinding);
            validateExternalAccountBinding(externalAccountBinding);
        }
    }

    private static void validateExternalAccountBinding(ModelNode externalAccountBinding) throws OperationFailedException {
