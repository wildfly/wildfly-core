...
class AuthenticationClientDefinitions {
    ...
    static ResourceDefinition getAuthenticationClientDefinition() {
        ...
        TrivialAddHandler<AuthenticationConfiguration> add = new TrivialAddHandler<AuthenticationConfiguration>(AuthenticationConfiguration.class, AUTHENTICATION_CONFIGURATION_RUNTIME_CAPABILITY) {
