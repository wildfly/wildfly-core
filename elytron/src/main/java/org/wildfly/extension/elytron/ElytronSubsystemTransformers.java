...
public final class ElytronSubsystemTransformers implements ExtensionTransformerRegistration {
    ...
    private static void from20(ChainedTransformationDescriptionBuilder chainedBuilder) {
        ...
        .addRejectCheck(RejectAttributeChecker.DEFINED, ElytronDescriptionConstants.EXPIRATION_WATERMARK)
        .setDiscard(DiscardAttributeChecker.UNDEFINED, ElytronDescriptionConstants.EXPIRATION_WATERMARK)
        .end();
    }
