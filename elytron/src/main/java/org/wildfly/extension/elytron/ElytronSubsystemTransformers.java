...
import static org.wildfly.extension.elytron.ElytronExtension.ELYTRON_18_1_0;
...
public final class ElytronSubsystemTransformers implements ExtensionTransformerRegistration {
    ...
    public void registerTransformers(SubsystemTransformerRegistration registration) {
        ...
        // 18.1.0 (WildFly 32) to 18.0.0 (WildFly 29)
        from18_1(chainedBuilder);
        ...
        chainedBuilder.buildAndRegister(registration, new ModelVersion[] { ELYTRON_18_1_0, ELYTRON_18_0_0, ELYTRON_17_0_0, ELYTRON_16_0_0, ELYTRON_15_1_0, ELYTRON_15_0_0, ELYTRON_14_0_0, ELYTRON_13_0_0, ELYTRON_12_0_0, ELYTRON_11_0_0, ELYTRON_10_0_0, ELYTRON_9_0_0,
    ...
    private static void from19(ChainedTransformationDescriptionBuilder chainedBuilder) {
        ResourceTransformationDescriptionBuilder builder = chainedBuilder.createBuilder(ELYTRON_19_0_0, ELYTRON_18_1_0);

        builder.addChildResource(PathElement.pathElement(ElytronDescriptionConstants.KEY_STORE))
        .getAttributeBuilder()
        .addRejectCheck(RejectAttributeChecker.DEFINED, ElytronDescriptionConstants.EXPIRATION_CHECK_DELAY)
        .setDiscard(DiscardAttributeChecker.UNDEFINED, ElytronDescriptionConstants.EXPIRATION_CHECK_DELAY)
        .end();
    }

    private static void from18_1(ChainedTransformationDescriptionBuilder chainedBuilder) {
        ResourceTransformationDescriptionBuilder builder = chainedBuilder.createBuilder(ELYTRON_18_1_0, ELYTRON_18_0_0);
