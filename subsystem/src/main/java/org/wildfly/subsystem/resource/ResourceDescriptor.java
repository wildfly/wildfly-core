...
public interface ResourceDescriptor extends AddResourceOperationStepHandlerDescriptor {
    ...
    static interface Configurator<C extends Configurator<C>> {
         ...
         * @return a reference to this configurator
         * @deprecated Superseded by {@link #requireChild(ResourceRegistration)}.
         */
        @Deprecated(forRemoval = true)
        default C requireChild(PathElement path) {
            return this.requireChildren(List.of(ResourceRegistration.of(path)));
        }
         ...
         * @return a reference to this configurator
         * @deprecated Superseded by {@link #requireChildren(Collection)}.
         */
        @Deprecated(forRemoval = true)
        default C requireChildren(Set<PathElement> paths) {
            return this.requireChildren(paths.stream().map(ResourceRegistration::of).collect(Collectors.toUnmodifiableList()));
        }
         ...
         * @return a reference to this configurator
         */
        default C requireChild(ResourceRegistration child) {
            return this.requireChildren(List.of(child));
        }
         ...
         * @return a reference to this configurator
         */
        C requireChildren(Collection<ResourceRegistration> children);
         ...
         * @return a reference to this configurator
         * @deprecated Superseded by {@link #requireSingletonChild(ResourceRegistration)}.
         */
        @Deprecated(forRemoval = true)
         ...
         * @return a reference to this configurator
         * @deprecated Superseded by {@link #requireSingletonChildren(Collection)}.
         */
        @Deprecated(forRemoval = true)
        default C requireSingletonChildren(Set<PathElement> paths) {
            return this.requireSingletonChildren(paths.stream().map(ResourceRegistration::of).collect(Collectors.toUnmodifiableList()));
        }
         ...
         * @return a reference to this configurator
         */
        default C requireSingletonChild(ResourceRegistration path) {
            return this.requireSingletonChildren(Set.of(path));
        }
         ...
         * @return a reference to this configurator
         */
        C requireSingletonChildren(Collection<ResourceRegistration> paths);
         ...
         * @return a reference to this configurator
         * @deprecated Use {@link #requireChildren(Collection)} instead.
         */
        @Deprecated(forRemoval = true)
        default <P extends Supplier<PathElement>> C provideRequiredChildren(Collection<P> providers) {
            return this.requireChildren(providers.stream().map(Supplier::get).map(ResourceRegistration::of).collect(Collectors.toUnmodifiableList()));
        }
         ...
         * @return a reference to this configurator
         * @deprecated Use {@link #requireSingletonChildren(Collection)} instead.
         */
        @Deprecated(forRemoval = true)
        default <P extends Supplier<PathElement>> C provideRequiredSingletonChildren(Collection<P> providers) {
            return this.requireSingletonChildren(providers.stream().map(Supplier::get).map(ResourceRegistration::of).collect(Collectors.toUnmodifiableList()));
        }
    }
    ...
    abstract static class AbstractConfigurator<C extends Configurator<C>> implements Configurator<C> {
        ...
        @Override
        public C requireChildren(Collection<ResourceRegistration> children) {
        ...
        @Override
        public C requireSingletonChildren(Collection<ResourceRegistration> children) {
