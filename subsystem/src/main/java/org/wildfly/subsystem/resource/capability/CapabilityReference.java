...
public interface CapabilityReference<T> extends CapabilityReferenceRecorder, CapabilityReferenceResolver<T> {
    ...
    abstract class AbstractCapabilityServiceDescriptorReferenceRecorder<T> implements CapabilityReference<T> {

        private final RuntimeCapability<Void> capability;
        private final NaryServiceDescriptor<T> requirement;

        AbstractCapabilityServiceDescriptorReferenceRecorder(RuntimeCapability<Void> capability, NaryServiceDescriptor<T> requirement) {
            this.capability = capability;
            this.requirement = requirement;
        }
    ...
    class CapabilityServiceDescriptorReferenceRecorder<T> extends AbstractCapabilityServiceDescriptorReferenceRecorder<T> {
        ...
        CapabilityServiceDescriptorReferenceRecorder(RuntimeCapability<Void> capability, NaryServiceDescriptor<T> requirement, List<RequirementNameSegmentResolver> requirementNameSegmentResolvers, List<UnaryOperator<String>> requirementPatternSegmentResolvers) {
