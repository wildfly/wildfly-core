...
import org.wildfly.subsystem.resource.RuntimeResourceRegistrar;
import org.wildfly.subsystem.resource.capability.ResourceCapabilityReferenceRecorder;

/**
 * Describes the properties of a resource operation handler.
 * @author Paul Ferraro
 */
public interface ResourceOperationStepHandlerDescriptor extends OperationStepHandlerDescriptor {
    /**
     ...
     */
    default Iterable<RuntimeResourceRegistrar> getRuntimeResourceRegistrars() {
