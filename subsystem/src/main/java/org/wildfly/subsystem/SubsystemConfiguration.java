...
public interface SubsystemConfiguration {
     ...
     * @param description the subsystem resource description
     ...
     */
    static SubsystemConfiguration of(SubsystemResourceDescription description, SubsystemModel model, Supplier<SubsystemResourceDefinitionRegistrar> registrarFactory) {
        return of(description.getName(), model, registrarFactory);
    }
