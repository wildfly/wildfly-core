...
public class FileAuditLogHandlerUnitTestCase {
    ...
    public void testLogFileRotated() throws IOException {
        System.clearProperty(FileAuditLogHandler.ROTATE_AT_STARTUP_PROPERTY_NAME);
    ...
    @Test
    public void testLogFileRotatedPropertyTrue() throws IOException {
        System.setProperty(FileAuditLogHandler.ROTATE_AT_STARTUP_PROPERTY_NAME, Boolean.TRUE.toString());
    ...
    public void testLogRotationDisabled() throws IOException {
        System.setProperty(FileAuditLogHandler.ROTATE_AT_STARTUP_PROPERTY_NAME, Boolean.FALSE.toString());
    ...
    private void initializeHandler() {
        FileAuditLogHandler auditLogHandler =
                new FileAuditLogHandler("name", "formatter", 0, pathManager, logFile.getPath(), null);
