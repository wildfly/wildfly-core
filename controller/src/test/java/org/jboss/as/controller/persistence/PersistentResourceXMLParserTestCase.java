...
public class PersistentResourceXMLParserTestCase {
    ...
    public void testWrappersAndGroups() throws Exception {
        ...
        ModelNode subsystem = createSubsystemModelNode(operations);
    ...
    public void testSimpleParser() throws Exception {
        ...
        ModelNode subsystem = createSimpleSubsystemModelNode(operations);
    ...
    private ModelNode createSimpleSubsystemModelNode(List<ModelNode> operations) {
        ...
        address = PathAddress.pathAddress(resource2.remove("address"));
        subsystem.get(address.getLastElement().getKeyValuePair()).set(resource2);

        System.out.println("subsystem = " + subsystem);
        return subsystem;
    }

    private ModelNode createSubsystemModelNode(List<ModelNode> operations) {
        ModelNode subsystem = new ModelNode();
        subsystem.set(operations.get(0));
        subsystem.remove("address");
        subsystem.remove("operation");
