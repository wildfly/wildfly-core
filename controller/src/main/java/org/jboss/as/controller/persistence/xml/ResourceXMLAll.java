...
public interface ResourceXMLAll extends ResourceXMLElementGroup, XMLAll<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    interface Builder extends ResourceXMLElementGroup.Builder<ResourceXMLAll, Builder>, XMLAll.Builder<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    }
