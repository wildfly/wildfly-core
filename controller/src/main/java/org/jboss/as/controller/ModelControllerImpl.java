...
class ModelControllerImpl implements ModelController {
    ...
    ModelControllerImpl(final ServiceRegistry serviceRegistry, final ServiceTarget serviceTarget,
        ...
        ManagementModelImpl mmi = new ManagementModelImpl(rootRegistration, Resource.Factory.create(), capabilityRegistry.createShadowCopy());
...
//            });
        ...
        */
        ...
        ManagementModelImpl cloneCapabilityRegistry() {
            //todo why is this even needed, return this; should be fine.
            return new ManagementModelImpl(resourceRegistration, rootResource, capabilityRegistry);
        }
