...
public interface OperationContext extends ExpressionResolver, CapabilityServiceDescriptorResolver, FeatureRegistry {
    ...
    /**
     * Get the node into which the details of server result in a multi-server managed domain operation should be written.
     *
     ...
     * to modify the runtime state before removing the service.
     *
     ...
     * <p>
     * This method performs an authorization check to ensure that the caller has the necessary permissions
     * to modify the runtime state before performing the service removal.
     *
     ...
     * If a write action was previously performed, the value read will be from an uncommitted copy of the management model.<br/>
     * <p>
     * This method performs an authorization check to ensure that the caller has the necessary permissions
     * to add the resource.
