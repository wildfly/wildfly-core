...
public interface ResourceXMLElement extends ResourceXMLContainer, XMLElement<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    class DefaultResourceContentXMLElement extends DefaultXMLElement<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> implements ResourceXMLElement {
        ...
        private DefaultResourceContentXMLElement(QName name, XMLCardinality cardinality, XMLContentReader<ModelNode> attributesReader, XMLContentWriter<ModelNode> attributesWriter, XMLContent<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> content) {
            super(name, cardinality, new ResourceXMLContainerReader(name, attributesReader, content), new ResourceXMLContainerWriter<>(name, attributesWriter, Function.identity(), content));
        }
    }
}
