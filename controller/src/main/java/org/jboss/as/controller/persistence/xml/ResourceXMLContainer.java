...
/**
 * Encapsulates an XML container for a resource.
...
public interface ResourceXMLContainer extends XMLContainer<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    class ResourceXMLContainerReader implements XMLContentReader<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>> {
        private final QName name;
        private final XMLContentReader<ModelNode> attributesReader;
        private final XMLContent<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> content;

        ResourceXMLContainerReader(QName name, XMLContentReader<ModelNode> attributesReader, XMLContent<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> content) {
            this.name = name;
        ...
        public void readElement(XMLExtendedStreamReader reader, Map.Entry<PathAddress, Map<PathAddress, ModelNode>> context) throws XMLStreamException {
            ...
            this.content.getReader().readElement(reader, context);
    ...
    class ResourceXMLContainerWriter<C> implements XMLContentWriter<C> {
        ...
        public void writeContent(XMLExtendedStreamWriter writer, C content) throws XMLStreamException {
            ...
            this.childContent.getWriter().writeContent(writer, this.model.apply(content));
        ...
        public boolean isEmpty(C content) {
            return this.attributesWriter.isEmpty(content) && this.childContent.getWriter().isEmpty(this.model.apply(content));
        }
    }
