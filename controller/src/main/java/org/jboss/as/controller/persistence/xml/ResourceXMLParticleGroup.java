...
public interface ResourceXMLParticleGroup extends ResourceXMLElementGroup, XMLParticleGroup<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    interface Builder<G extends ResourceXMLParticleGroup, B extends Builder<G, B>> extends ResourceXMLElementGroup.Builder<G, B>, XMLParticleGroup.Builder<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
        @Override
        B addChoice(XMLChoice<Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> choice);
    }

    abstract class AbstractBuilder<G extends ResourceXMLParticleGroup, B extends Builder<G, B>> extends XMLParticleGroup.AbstractBuilder<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode, B> implements Builder<G, B> {
