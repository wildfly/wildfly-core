 ...
 * @author Paul Ferraro
 */
public interface ResourceRegistrationXMLElement extends ResourceXMLContainer, ResourceRegistration, XMLElement<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> {
    ...
    abstract class AbstractBuilder<T extends ResourceRegistrationXMLElement, B extends Builder<T, B>> extends ResourceXMLContainer.AbstractBuilder<T, B> implements Builder<T, B> {
        ...
        protected AbstractBuilder(ResourceRegistration registration, FeatureFilter filter, QNameResolver resolver) {
            ...
            this.withCardinality(this.registration.getPathElement().isWildcard() ? XMLCardinality.Unbounded.OPTIONAL : XMLCardinality.Single.OPTIONAL);
        }
    ...
    class DefaultResourceRegistrationXMLElement extends DefaultXMLElement<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>, ModelNode> implements ResourceRegistrationXMLElement {
        ...
        DefaultResourceRegistrationXMLElement(ResourceRegistration registration, QName name, XMLCardinality cardinality, XMLContentReader<Map.Entry<PathAddress, Map<PathAddress, ModelNode>>> reader, XMLContentWriter<ModelNode> writer) {
