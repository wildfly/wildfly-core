...
public class SubsystemExtensionTransformerRegistration implements ExtensionTransformerRegistration {
    ...
    protected <E extends Enum<E> & SubsystemModel> SubsystemExtensionTransformerRegistration(SubsystemResourceDescription description, E currentModel, Function<ModelVersion, TransformationDescription> factory) {
