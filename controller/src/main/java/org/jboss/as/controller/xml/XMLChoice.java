                    ...
                    if (choice != null) {
                        ...
                        do {
                            ...
                            if (occurrences > maxOccurs) {
                                throw ParseUtils.maxOccursExceeded(reader, choice.getAllNames(), choice.getCardinality());
                            }
                        ...
                        if (occurrences < choice.getCardinality().getMinOccurs()) {
                            throw ParseUtils.minOccursNotReached(reader, choice.getAllNames(), choice.getCardinality());
                        }
