...
public enum ProcessType {
    ...
    SELF_CONTAINED(true, false, true);
    ...
    /**
     * Returns true if the process is an embedded process.
     *
     * @return Returns <tt>true</tt> if the process is an embedded process. Returns <tt>false</tt> otherwise.
     */
