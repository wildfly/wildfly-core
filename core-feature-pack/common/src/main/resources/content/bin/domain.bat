...
if %errorlevel% equ 20 (
    ...
    call "!JBOSS_HOME!\bin\_installation-manager_helper.bat" "!JBOSS_HOME!" "!JBOSS_CONFIG_DIR!\logging.properties" "!JBOSS_LOG_DIR!\host-controller.log" >> "!INST_MGR_CONSOLE_FILE!" 2>&1
    if !ERRORLEVEL! equ 0 (
