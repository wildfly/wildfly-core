...
//            CURRENT_THREAD_ALLOCATED_BYTES.getName()
    ...
    public void registerOperations(ManagementResourceRegistration threads) {
        ...
        threads.registerOperationHandler(ThreadMXBeanThreadsAllocatedBytes.DEFINITION, ThreadMXBeanThreadsAllocatedBytes.INSTANCE);
        threads.registerOperationHandler(ThreadMXBeanThreadAllocatedBytes.DEFINITION, ThreadMXBeanThreadAllocatedBytes.INSTANCE);
    }
}
