 ...
 *
 */
public class ThreadMXBeanThreadsAllocatedBytes implements OperationStepHandler {
    ...
    public static final ThreadMXBeanThreadsAllocatedBytes INSTANCE = new ThreadMXBeanThreadsAllocatedBytes();

    private final ParametersValidator idsValidator = new ParametersValidator();

    private ThreadMXBeanThreadsAllocatedBytes() {
