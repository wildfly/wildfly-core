 ...
 */
@CommandDefinition(name = "list-unavailable", description = "")
public class CommandsListUnavailable extends AbstractListCommand implements Command<CLICommandInvocation> {

    private final CLICommandRegistry aeshRegistry;

    public CommandsListUnavailable(CLICommandRegistry aeshRegistry) {
    ...
    public CommandResult execute(CLICommandInvocation commandInvocation) throws CommandException, InterruptedException {
        ...
        ctx.println("Commands not available in the current context:");
        print(lst, ctx);
