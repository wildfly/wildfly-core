 ...
 */
@CommandDefinition(name = BatchCommand.LIST_COMMANDS, description = "", activator = BatchActivator.class)
public class BatchListCommand implements Command<CLICommandInvocation>, LegacyBridge {
    ...
    public CommandResult execute(CLICommandInvocation commandInvocation)
        ...
        if (help) {
            commandInvocation.println(commandInvocation.getHelpInfo("batch " + BatchCommand.LIST_COMMANDS));
            return CommandResult.SUCCESS;
        }

        //Legacy compliance
        CommandResult res = BatchCommand.handle(commandInvocation, BatchCommand.LIST_COMMANDS);
        if (res != null) {
            return res;
        }
