...
public class CommandContextImpl implements CommandContext, ModelControllerClientFactory.ConnectionCloseHandler {
    ...
    private void initCommands() throws CommandLineException, CommandLineParserException {
        ...
        // deployment
        cmdRegistry.registerHandler(new DeployHandler(this), false, "deploy");
        cmdRegistry.registerHandler(new UndeployHandler(this), false, "undeploy");
        cmdRegistry.registerHandler(new DeploymentInfoHandler(this), false, "deployment-info");
