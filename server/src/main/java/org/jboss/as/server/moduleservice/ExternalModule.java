...
public interface ExternalModule {
     ...
     * @deprecated Use {@link #addExternalModuleAsString(String, String, ServiceRegistry, ServiceTarget)} instead.
     */
     ...
     *
     * @deprecated Use {@link #addExternalModuleAsString(String, ServiceRegistry, ServiceTarget)} instead.
     */
    @Deprecated(forRemoval = true, since = "28.0.0")
