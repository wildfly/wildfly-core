...
public class ModuleLoadingResourceDefinition extends SimpleResourceDefinition {
    ...
    private static List<String> findResourcePaths(String moduleName) throws ModuleLoadException, IOException, OperationFailedException, URISyntaxException {
        ...
        for (ResourceLoaderInfo rl : loader.getResourceLoaders(moduleName)) {
            ...
            if (location != null && !location.equals("null")) {
                ...
                if (url.getProtocol().equals("jar")) {
                    ...
                    result.add(Path.of(url.toURI()).toString());
                }
            }
        }
