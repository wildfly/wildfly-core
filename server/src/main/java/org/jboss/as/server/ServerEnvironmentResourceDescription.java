...
public class ServerEnvironmentResourceDescription extends SimpleResourceDefinition {
    ...
    static final AttributeDefinition FEATURE_STREAM = SimpleAttributeDefinitionBuilder.create("feature-stream", ModelType.STRING).setFlags(AttributeAccess.Flag.STORAGE_RUNTIME).build();
    ...
    private static final AttributeDefinition[] SERVER_ENV_ATTRIBUTES = { BASE_DIR, CONFIG_DIR, CONFIG_FILE, CONTENT_DIR, DATA_DIR,
            ...
            QUALIFIED_HOST_NAME, SERVER_NAME, TEMP_DIR, START_SUSPENDED, GRACEFUL_STARTUP, FEATURE_STREAM };
    ...
    private static class ServerEnvironmentReadHandler implements OperationStepHandler {
        ...
        public void execute(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            } else if (equals(name, FEATURE_STREAM)) {
                result.set(environment.getFeatureStream().toString());
            }
        }
