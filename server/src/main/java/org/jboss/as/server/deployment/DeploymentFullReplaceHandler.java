            ...
            public void handleResult(ResultAction resultAction, OperationContext context, ModelNode operation) {
                if (resultAction == ResultAction.KEEP) {
                    if (replacedHash != null  && (newHash == null || !Arrays.equals(replacedHash, newHash))) {
                        ...
                        contentRepository.removeContent(ModelContentReference.fromDeploymentAddress(address, replacedHash).toReference());
                    }
                    if (newHash != null) {
                    ...
                    contentRepository.removeContent(ModelContentReference.fromDeploymentAddress(address, newHash).toReference());
                }
            }
        });
    }
