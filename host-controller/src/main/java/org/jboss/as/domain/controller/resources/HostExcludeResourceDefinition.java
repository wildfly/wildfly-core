...
public class HostExcludeResourceDefinition extends SimpleResourceDefinition {
    ...
    public static final AttributeDefinition IGNORED_EXTENSIONS = new StringListAttributeDefinition.Builder(ModelDescriptionConstants.IGNORED_EXTENSIONS)
            .setAllowNull(true)
            .build();
    ...
    private static final AttributeDefinition[] attributes = { MANAGEMENT_MAJOR_VERSION, MANAGEMENT_MINOR_VERSION,
            MANAGEMENT_MICRO_VERSION, HOST_RELEASE, IGNORED_EXTENSIONS, ACTIVE_SERVER_GROUPS, ACTIVE_SOCKET_BINDING_GROUPS};
    ...
    private static void registerHostExcludes(OperationContext context, ModelNode model, DomainHostExcludeRegistry registry) throws OperationFailedException {
        ...
        ModelNode ie = IGNORED_EXTENSIONS.resolveModelAttribute(context, model);
