...
public enum IOSubsystemSchema implements SubsystemResourceXMLSchema<IOSubsystemSchema> {
    ...
    public SubsystemResourceRegistrationXMLElement getSubsystemXMLElement() {
        ...
        if (this.since(VERSION_2_0)) {
            workerBuilder.withContent(XMLChoice.singleton(this.factory.element(WildcardResourceRegistration.of(OutboundBindAddressResourceDefinition.PATH)).addAttributes(OutboundBindAddressResourceDefinition.ATTRIBUTES).build()));
        }
