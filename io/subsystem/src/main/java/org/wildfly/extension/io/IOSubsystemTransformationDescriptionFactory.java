    ...
    public TransformationDescription apply(ModelVersion version) {
        ...
        if (IOSubsystemModel.VERSION_6_0_0.requiresTransformation(version)) {
            builder.getAttributeBuilder()
                .setDiscard(new DiscardAttributeChecker.DiscardAttributeValueChecker(IOSubsystemResourceRegistrar.LEGACY_DEFAULT_WORKER), IOSubsystemResourceRegistrar.DEFAULT_WORKER)
                .addRejectCheck(RejectAttributeChecker.DEFINED, IOSubsystemResourceRegistrar.DEFAULT_WORKER)
                .end();
        }
