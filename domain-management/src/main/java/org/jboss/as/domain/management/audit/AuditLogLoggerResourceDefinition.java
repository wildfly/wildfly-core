...
public class AuditLogLoggerResourceDefinition extends SimpleResourceDefinition {
    ...
    private static class AuditLogMaskOpParamWriteAttributeHandler extends AbstractWriteAttributeHandler<Boolean> {

        private final ManagedAuditLogger auditLogger;

        AuditLogMaskOpParamWriteAttributeHandler(ManagedAuditLogger auditLogger) {
            this.auditLogger = auditLogger;
        }
