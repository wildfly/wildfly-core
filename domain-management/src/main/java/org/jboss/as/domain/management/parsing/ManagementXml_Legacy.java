...
class ManagementXml_Legacy extends ManagementXml {
    ...
    private void parseManagement_1_5(final XMLExtendedStreamReader reader, final ModelNode address,
        ...
        while (reader.hasNext() && reader.nextTag() != END_ELEMENT) {
            ...
            switch (element) {
                ...
                case ACCESS_CONTROL: {
                    if (delegate.parseAccessControl(reader, this, managementAddress, namespace, list) == false) {
                        throw unexpectedElement(reader);
                    }
    ...
    private String generateAlias(final String type, final String name, final String realm) {
        return type + "-" + name + (realm != null ? "@" + realm : "");
    }

    public void parseAccessControlConstraints(final XMLExtendedStreamReader reader, final ModelNode accAuthzAddr,
                                                     final List<ModelNode> list) throws XMLStreamException {
        ParseUtils.requireNoAttributes(reader);
...
//        }
    ...
    public void writeManagement(final XMLExtendedStreamWriter writer, final ModelNode management, boolean allowInterfaces)
        ...
        if (accessAuthorizationDefined) {
            writeAccessControl(writer, accessAuthorization);
        }

        writer.writeEndElement();
    }

    private void writeAccessControl(final XMLExtendedStreamWriter writer, final ModelNode accessAuthorization) throws XMLStreamException {
    ...
    private Map<String, Map<String, Set<String>>> getConfiguredAccessConstraints(ModelNode accessAuthorization) {
    ...
    private Map<String, Map<String, Set<String>>> getApplicationClassificationConstraints(final ModelNode constraint) {
        Map<String, Map<String, Set<String>>> configuredConstraints = new HashMap<String, Map<String, Set<String>>>();
    ...
    private void writeAttribute(XMLExtendedStreamWriter writer, Attribute attribute, String value)
            throws XMLStreamException {
