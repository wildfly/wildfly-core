 ...
 */
class LoggingSubsystemParser_3_0 extends LoggingSubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>> {

    LoggingSubsystemParser_3_0() {
        //
    }
