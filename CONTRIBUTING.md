...
WildFly Core uses JIRA to manage issues. All issues can be found [here](https://redhat.atlassian.net/browse/WFCORE).
...
Check out our issues with the `good-first-issue` label. These are a triaged set of issues that are great for getting started on our project. These can be found [here](https://redhat.atlassian.net/issues/?filter=110927).
