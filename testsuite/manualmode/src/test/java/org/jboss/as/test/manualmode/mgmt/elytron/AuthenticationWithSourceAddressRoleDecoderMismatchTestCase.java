 ...
 * with the use of a source-address-role-decoder where the IP address of the client does not match the
...
public class AuthenticationWithSourceAddressRoleDecoderMismatchTestCase {
    ...
    public static void prepareServerConfiguration() throws Exception {
        ...
        try (CLIWrapper cli = new CLIWrapper(true)) {
            ...
            cli.sendLine(String.format(
                    "/subsystem=elytron/source-address-role-decoder=%s:add(source-address=%s,roles=[Admin])", ROLE_DECODER_1_NAME, "999.999.999.999"));
            cli.sendLine(String.format(
    ...
    */
    ...
    public void testAuthenticationIPAddressMismatch() throws Exception {
        CoreUtils.makeCallWithBasicAuthn(createSimpleManagementOperationUrl(), USER_ALICE, PASSWORD_ALICE, SC_UNAUTHORIZED);
