 ...
 * @author Paul Ferraro
 */
public abstract class DiscoveryProviderResourceRegistrar implements ChildResourceDefinitionRegistrar, ResourceServiceConfigurator, ResourceModelResolver<ServiceDependency<DiscoveryProvider>> {
    ...
    private final DiscoveryProviderResourceRegistration registration;
    private final Collection<AttributeDefinition> attributes;

    DiscoveryProviderResourceRegistrar(DiscoveryProviderResourceRegistration registration, Collection<AttributeDefinition> attributes) {
    ...
    public ManagementResourceRegistration register(ManagementResourceRegistration parent, ManagementResourceRegistrationContext context) {
        ResourceDescriptor descriptor = ResourceDescriptor.builder(DiscoverySubsystemResourceRegistrar.RESOLVER.createChildResolver(this.registration.getPathElement()))
    ...
    public ResourceServiceInstaller configure(OperationContext context, ModelNode model) throws OperationFailedException {
        return CapabilityServiceInstaller.builder(DiscoveryProviderResourceRegistrar.DISCOVERY_PROVIDER_CAPABILITY, this.resolve(context, model)).build();
    }
}
